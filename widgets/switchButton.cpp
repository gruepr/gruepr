    ...
    , _enabled(true)
{
    ...
    _labeloff->setStyleSheet("color: rgb(120, 120, 120);");
    _labelon->setStyleSheet("color: rgb(255, 255, 255);");
    ...
    , _pencolor(QColor(170, 170, 170))
{
    ...
    _lg.setColorAt(0, _color);
    _lg.setColorAt(0.25, _color.lighter(150));
    _lg.setColorAt(0.95, _color);
