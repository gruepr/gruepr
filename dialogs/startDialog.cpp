    ...
    :QDialog (parent)
{
    ...
    topLabel->setStyleSheet("QLabel { color: #" GRUEPRDARKBLUEHEX "; }");
    ...
    registerLabel->setStyleSheet("QLabel { color: #" GRUEPRDARKBLUEHEX "; }");
    ...
    upgradeLabel->setStyleSheet("QLabel { color: #" GRUEPRDARKBLUEHEX "; }");
