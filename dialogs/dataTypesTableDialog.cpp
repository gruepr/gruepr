...
dataTypesTableDialog::dataTypesTableDialog(QWidget *parent) : QDialog(parent) {
    ...
    QStringList dataTypes = {
        ...
        "Preferred Teammates", "Preferred Non-teammates", "Multiple Choice or Numerical", "Notes"
    };
    ...
    QStringList descriptions = {
        ...
        "Student's enrolled course section", "Student's timezone",
        ...
        "Student's response(s) to a instructor-defined multiple-choice or numerical response question",
    ...
    QStringList formats = {
        ...
        "Categorical", "Categorical", "List of names (comma separated)",
        "List of names (comma separated)", "Numerical, or Multiple choice with categorical / Likert scale answers",
        "Free response"
    };
    ...
    QStringList examples = {
        ...
        "8AM;9AM;10AM;", "Mon/Wed Section", "EST",
        "\"Preston Polasek, Shelia Swafford\"", "Bryan Blackwelder",
        "93.5, or \"Chemistry, Physics\"",
        "Free response"
    };
